...
import {
  ...
  XCircle, LogOut, LayoutDashboard, X, Hash, Database
} from "lucide-react";
...
const ADMIN_LINKS = [
  ...
  { label: "ID Settings", path: "/admin/id-settings", icon: Hash },
  { label: "Master Data Setup", path: "/admin-setup", icon: Database },
];
