...
import { Bell, ChevronDown, User, Lock, RefreshCw, LogOut, Menu, X, ArrowLeft, Search } from "lucide-react";
            ...
            <div className="flex items-center gap-2 lg:gap-4">
              ...
              <form
                onSubmit={(e) => {
                  ...
                  if (!q) return;
                  navigate(`/audit-view?q=${encodeURIComponent(q)}`);
                }}
              ...
              >
                ...
                <Input
                  ...
                  className="h-9 pl-8 w-48 lg:w-64"
                />
              </form>
