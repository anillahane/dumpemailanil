...
import AdminIdSettingsPage from "./pages/AdminIdSettingsPage";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route
              ...
              element={
                <ObservationListPage
                  ...
                  filterFn={(o) => Boolean(o.isOverdue) || Boolean(o.isSentBack) || o.issueStatus === "Rejected"}
                  showDaysLeft
                />
              }
            />
            ...
            />
            <Route path="/admin/id-settings" element={<AdminIdSettingsPage />} />
            <Route path="/admin-setup" element={<AdminSetupPage />} />
            <Route path="/observation/:issueId" element={<ObservationDetailPage />} />
