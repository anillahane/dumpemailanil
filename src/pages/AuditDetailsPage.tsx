...
import { MOCK_AUDITS, PROCESS_OPTIONS, RISK_CLASSIFICATIONS, DEPARTMENTS, ISSUE_CATEGORIES, OBSERVATION_STATUSES } from "@/data/mockData";
                        ...
                        <tbody className="divide-y">
                          {editableObservations.map((observation, index) => (
                            <tr key={`${observation.issueId}-${index}`}>
                              <td className="px-4 py-3 min-w-28"><Input readOnly value={observation.issueId} className="font-mono bg-muted/40" title="Auto-generated. Format managed in Admin → ID Settings." /></td>
                              <td className="px-4 py-3 min-w-44">
                        ...
                        <div key={`${observation.issueId}-${index}`} className="p-4 space-y-3">
                          <div className="grid grid-cols-2 gap-3">
                            <div>
                              ...
                              <Input readOnly value={observation.issueId} className="font-mono bg-muted/40" title="Auto-generated. Format managed in Admin → ID Settings." />
                            </div>
                            <div>
